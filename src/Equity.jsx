...
const Equity = () => {
  ...
  const equityHoldings = holdings.filter(holding => holding.asset_class === 'Equity');
  ...
  return (
    <div>
      ...
      {showDetails && (
        ...
        <th style={{ paddingRight: '5rem' }}>TICKER</th>
        <th style={{ paddingRight: '5rem' }}>AVERAGE PRICE</th>
        <th style={{ paddingRight: '5rem' }}>MARKET PRICE</th>
        <th style={{ paddingRight: '5rem' }}>LATEST CHANGE PERCENTAGE</th>
        <th style={{ paddingRight: '5rem',backgroundColor:"aliceblue"  }}>MARKET VALUE IN BASE CCY</th>
              </tr>
            </thead>
            <tbody >
