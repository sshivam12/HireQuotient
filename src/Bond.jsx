...
const Bond = () => {
  ...
  const bondHoldings = holdings.filter(holding => holding.asset_class === 'Bond');
  console.log('bond Holdings:', bondHoldings);
  ...
  return (
    <div>
      ...
      {showDetails && (
        ...
        <th style={{ paddingRight: '3rem' }}>TICKER</th>
        <th style={{ paddingRight: '3rem' }}>AVERAGE PRICE</th>
        <th style={{ paddingRight: '3rem' }}>MARKET PRICE</th>
        <th style={{ paddingRight: '3rem' }}>LATEST CHANGE PERCENTAGE</th>
